...
namespace AdventOfCode2020.DayTemplate
{
    public class ChallengeDayX : IAdventCodeDayChallenge
    {
        private readonly IDataProvider<int> _dataProvider;
        private readonly TextWriter _output;

        public ChallengeDayX(IDataProvider<int> dataProvider, TextWriter output)
        {
