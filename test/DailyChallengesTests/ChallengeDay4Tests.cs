...
namespace DailyChallengesTests
{
    public class ChallengeDay4Tests
    {
        ...
        [InlineData("ecl")]
        [InlineData("pid")]
        public void Passport_Should_Be_Invalid_When_Missing_Required_Field(string missingField)
        {
        ...
        private static readonly string[] InvalidData = new[]
        {
            "eyr:1972 cid:100",
        ...
        private static readonly string[] ValidData = new[]
        {
